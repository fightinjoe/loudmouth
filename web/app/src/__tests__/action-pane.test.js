...
describe("action pane — new-phrasebook suggestion hand-off", () => {
  it("confirming a suggestion builds an unsaved preview deck via content/loaded and closes the sheet", async () => {
    const suggestion = {
